        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (bankCardChkBx.isChecked()) {
                    Toast.makeText(MainActivity.this, R.string.toastPaymentBankCard, Toast.LENGTH_LONG).show();
                }
                else if (mobilePhoneChkBx.isChecked()) {
                    Toast.makeText(MainActivity.this, R.string.toastPaymentMobilePhone, Toast.LENGTH_LONG).show();
                }
                else if (cashAddressChkBx.isChecked()) {
                    Toast.makeText(MainActivity.this, R.string.toastPaymentCashAddress, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
